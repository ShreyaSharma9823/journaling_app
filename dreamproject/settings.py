...
# SECURITY WARNING: don't run with debug turned on git pushin production!
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATES_BASE_DIR := BASE_DIR / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR /'dreamproject' / 'staticfiles'
